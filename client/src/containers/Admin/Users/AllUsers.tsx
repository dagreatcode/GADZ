...
const AllUsers = () => {
  return (
    <>
     ...
     <a href="https://gadzconnect.com/api/user/AllUsers">Users API. This is Raw Data coming from the database. This will be user to apply all Users Information to the page for the admin edit user or freeze user or even archive."</a>        
    </>
  )
}
