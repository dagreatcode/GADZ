...
const Agreed = () => {
  ...
  useEffect(() => {
    // const getData = async () => {
      try {
        ...
        // console.log("agree data",res.data)
        // setTour(res.data);
      } catch (err) {
  ...
  return (
    <>
      ...
      entered on {tour.date}(the "effective date") by and between Berhenny Dean
      Co, a New Jersey limited liability Company, and, a Registered Motor
      Carrier with its principal office at
      {"Description"}
      ("Carrier"): collectively referred to as the "Parties". <br />
      <br />
      WHEREAS, DISPATCHER is an Independent Contractor conducting Load Tendering
      Transitions between Freight Shippers or Freight Holders, and Carriers
      authorized by the Federal Motor Carrier Safety Administration ("FMCS") to
      operate as a Registered Property Carriers Pursuant to Licenses issued.
      DISPATCHER is not a broker nor acting as a broker to the CARRIER. <br />
      <br />
      ...
      Freight Shippers/Holders as defined in 49 U.S.C. $13102 (4) and §14101 (b)
      and not between DISPATCHER, and the Parties hereto intend that the
      ...
      problems, advances (all advances will have to be handled directly between
      CARRIER and shipper/broker), handling and storage of paperwork all
      documents will be sent to CARRIER, (at Carrier's expense), and DOT
      ...
      invoice. All DISPATCHER fees must be paid after each load has been booked
      and accepted by the CARRIER. CARRIER must, prior to the implementation, of
      this agreement furnish to DISPATCHER the following: <br />
      <br />
      <ol>
