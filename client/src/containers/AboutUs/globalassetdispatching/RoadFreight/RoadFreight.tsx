      ...
      <div className="container2" style={{ textAlign: "center" }}>
        ...
        <div className="row">
          <div className="display-4" style={{ padding: "40px" }}>
            ...
            objectives. We Provide Land Freight Transport Services In The
            Following Areas: Dry, frozen, and refrigerated truckload. LTL
            service including online pricing, booking, and tracking. Local,
            regional, and long-haul drayage. Flatbed, drop-deck, and double-drop
          ...
          <div className="display-4" style={{ padding: "40px" }}>
            ...
            you help with documentation support? Documentation is key! It keeps
            us and our business partners in alignment with safety and
            regulation. We also enjoy being well organized. As the world evolves
            and continue to go digital, we encourage a digital documentation
            support system to help make your business run effectively and
            efficiently. Are you committed to your partners? Global Asset is
            built with integrity We believe in loyalty, trust and transparency.
            The committment is a mutual agreement and we desire to work with
            strong minded individuals with the understanding in building up ones
            business with integrity and respect. Do you help find drivers for
            trucking companies? We work with a network of organizations and
            business owners. Which are encouraged to support all small to large
            businesses. Helping your company grow by finding qualified drivers
            and dedicated lanes. Steady freight is what we take much pride in!
            What does a business to business partnership look like with GAD? We
            are here to help your business work smarter and not harder! We focus
            on helping you to overcome barriers, find resource, grow your
            network and scale up your revenue goals!
          </div>
        </div>
      </div>
    </>
